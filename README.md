...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/flat-queen-b8c1)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/flat-queen-b8c1
```

A live public deployment of this template is available at [https://flat-queen-b8c1.templates.workers.dev](https://flat-queen-b8c1.templates.workers.dev)
